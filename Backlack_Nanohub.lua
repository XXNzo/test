...
mainopens.Parent = mainopen
 ...
 loki.Image = "rbxassetid://16162633293"
 ...
 TabImage.Image = img or "rbxassetid://16162633293"
...
OkayBtn.MouseButton1Click:Connect(function()
 ...
 ImageButton.Image = "rbxassetid://16162633293"
 ...
 DropImage.Image = "rbxassetid://16162633293"
    ...
    function InfAb()
        if InfAbility then
            if not game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility") then
                ...
                inf.Texture = "rbxassetid://16162633293"
...
--------------------------------------------------------------------
local Library = Update:Window("Nano Hub ","")
------------------------------------------
...
--------------------------
local NanoMod = Libraty:Tab("NanoMod","rbxassetid://16162633293")
...
Setting:Label("🌟WELCOME TO NANO HUB")

Setting:Line()

Setting:Button("Copy Discord Link",function()
 
 setclipboard("https://discord.com/invite/9N6b65vxss")
 end)
...
wait(1)
Notification:Notify(
   {Title = "Nano HUB", Description = "You Have Max Observation"},
...
SoundSFX.SoundId = "rbxassetid://16162633293"
SoundSFX:Play()
